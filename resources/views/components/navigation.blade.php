...
<header class="bg-white px-6 shadow dark:bg-slate-900">
    ...
    >
      ...
      <div class="-mr-4 flex items-center">
        ...
        <div class="ml-8 hidden space-x-8 md:flex">
            <a class="px-3 py-2 {{ request()->routeIs('home') ? 'text-sky-500' : 'text-slate-600 transition-colors hover:text-sky-500 dark:text-slate-400 dark:hover:text-sky-500' }}" href="{{ route('home') }}">
                {{ __('Home') }}
            </a>
    ...
    >
        ...
        <a
            href="{{ route('posts.index') }}"
            class="block rounded-md px-3 py-2 {{ request()->routeIs('posts.index') ? 'bg-sky-500 text-white' : 'text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white' }}"
        >
            {{__('Blog')}}
        </a>
